...
sprc(colors.cyan, "  ОС:        Srunix 0.5.0")
sprc(colors.cyan, "  Ядро:      монолитное (Lua)")
sprc(colors.cyan, "  Хост:      " .. host)
sprc(colors.cyan, "  Пользователь: " .. (Srunix.user or "root"))
sprc(colors.cyan, "  Диск:      " .. math.floor(used/1024) .. " KB исп. / " .. math.floor(free/1024) .. " KB своб.")
sprc(colors.cyan, "  Экран:     " .. term.getSize() .. " (текст)")
sprc(colors.cyan, "  Графика:   " .. (term.setGraphicsMode and "CC:Graphics (256 цветов)" or "нет"))
sprc(colors.cyan, "  GPU:       " .. (peripheral.find("tm_gpu") and "Tom's Peripherals" or "нет"))
